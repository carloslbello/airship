...
pythons = [('Python 2.6', 'python2.6'), ('Python 2.7', 'python2.7'), ('Python 3.2', 'python3.2'), ('Python 3.3', 'python3.3'), ('Python 3.4', 'python3.4'), ('Python 3.5', 'python3.5'), ('PyPy', 'pypy'), ('PyPy3', 'pypy3')]
